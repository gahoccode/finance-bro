...
class TestPortfolioReportGeneration:
    ...
    def test_filepath_construction(self, temp_reports_dir, mock_timestamp):
        ...
        expected_path = os.path.join(temp_reports_dir, "Max_Sharpe_Portfolio_20250109_120000")
    ...
    def test_excel_filepath_construction(self, temp_reports_dir, mock_timestamp):
        ...
        expected_xlsx_path = os.path.join(temp_reports_dir, "Max_Sharpe_Portfolio_20250109_120000.xlsx")
    ...
    def test_riskfolio_called_with_correct_path(self, mock_excel_report, temp_reports_dir, 
                                               sample_returns_df, sample_weights, mock_timestamp):
        ...
        selected_weights_df = pd.DataFrame.from_dict(sample_weights, orient='index', columns=[portfolio_name])
        ...
        mock_excel_report(returns=sample_returns_df, w=selected_weights_df, name=filepath_base)
    ...
    def test_file_operations_use_correct_xlsx_path(self, mock_getsize, mock_excel_report, 
                                                  temp_reports_dir, sample_returns_df, 
                                                  sample_weights, mock_timestamp):
...
class TestPortfolioWeightProcessing:
    ...
    def test_empty_weights_handling(self):
        ...
        selected_weights_df = pd.DataFrame.from_dict(empty_weights, orient='index', columns=[portfolio_name])
