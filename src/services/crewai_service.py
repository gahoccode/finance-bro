...
def run_financial_health_analysis():
    ...
    try:
        ...
        if 'stock_symbol' not in st.session_state:
            raise ValueError("No stock symbol selected. Please select a stock symbol first.")
        
        if 'dataframes' not in st.session_state or not st.session_state.dataframes:
            raise ValueError("No financial dataframes found. Please load financial data first.")
