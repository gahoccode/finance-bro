...
Manual implementation of technical indicators using pandas and numpy.
...
def manual_rsi(close_prices: pd.Series, period: int = 14) -> pd.Series:
    ...
    # Use alpha = 1/period for EMA (standard approach)
    alpha = 1.0 / period
...
def calculate_technical_indicators(data: pd.DataFrame) -> dict:
    ...
    Returns:
        Dictionary of calculated indicators with standard structure
    """
    indicators = {}
    warnings = []
